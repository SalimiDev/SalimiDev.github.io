...
const About = () => {
    return (
        <div className='h-[90%] lg:flex justify-center font-nunito px-3 text-grayAccent-800 dark:text-primary-white '>
                ...
                <div className='space-y-5 lg:flex lg:space-x-5 items-center'>
                    ...
                    <div className='lg:w-1/2 pr-5 space-y-4'>
                        ...
                        <ul className='dark:text-primary-100 leading-8'>
                            <li><strong>Full Name :</strong>Mehdi Salimi</li>
                            <li><strong>Age :</strong>30 years</li>
                            <li><strong>Nationality :</strong>Iranian</li>
                            <li><strong>Languages :</strong>English, Persian</li>
                            <li><strong>Address :</strong>Tehran, Iran</li>
                            <li><strong>Freelance :</strong>Available</li>
                        </ul>
                        <button style={{marginTop: '40px'}} className='px-4 py-2 lg:px-6 lg:py-3 bg-primary-300 text-primary-white'>DOWNLOAD RESUME</button>
                    </div>
                </div>
            </div>
